namespace WindowsFormsApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Location = new Point(275, 125);
            ...
            button1.Location = new Point(275, 290);
            button1.Margin = new Padding(4, 3, 4, 3);
            button1.Name = "button1";
            button1.Size = new Size(317, 49);
            button1.TabIndex = 4;
            button1.Text = "Login";
            ...
            label3.Location = new Point(362, 22);
            label3.Name = "label3";
